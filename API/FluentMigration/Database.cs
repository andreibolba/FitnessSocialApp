...
namespace API.FluentMigration
{
    public class Database
    {
        ...
        private const string ConnectionString = "Data Source=localhost;Initial Catalog=FitnessSocialApp;User Id=sa;Password=1234%asd; TrustServerCertificate=True";
    }
}